...
const actions = ["The creature attacks! Defend yourself!", "The creature runs off in fear.", "The creature attacks you but you fell it before it can do any damage. Victory!", "The creature attacks you and lands a critical hit, you bleed out on the ground and die. (BAD END)", "The bandit robs you at knife point, will you fight or give up your coin?", "The bandit seeing your imposing stature decides to scurry off.", "The two of you strike up pleasant conversation.", "You end up purchasing a useful item.", "You are directed not to enter.", "The wizard recruits you as an apprentice and you live happily ever after. (GOOD END)"];
const ASCII = [
String.raw`
      .-.
     (o.o)
...
// selects path to background image dependent on locationIndex
